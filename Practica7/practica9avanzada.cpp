...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//Agregar movimiento a las texturas
		//toffsetflechau += 0.001;
		//toffsetflechav += 0.0;     
		//toffset.x = toffsetflechau;
	...
	/*	toffsetnumerocambiau += 0.25;
		...
		if (offsetCambio > 300) {
			toffsetnumerocambiau += 0.25;
			offsetCambio = 0.0f;
			numContador += 1; //para controlar el cambio de textura

			if (toffsetnumerocambiau == 1.0f) {
				toffsetnumerocambiav -= 0.33f;
			}
			if (numContador > 9) {
				toffsetnumerocambiau = 1.0f;
				toffsetnumerocambiav = 0.0f;
				numContador = 0;
				num1 = !num1;   //cambiar entre textura 1 y 2
			}
		}
		...
		if (toffsetnumerocambiav >= 1.0f)
			toffsetnumerocambiav = 0.99f;
