...
float posXanya = 0.0, posYanya = -18.0, posZanya = 0.0;
...
int main()
{
	...
	glm::vec3 posAnya = glm::vec3(0.0f, -10.0f, 0.0f);
	...
	KeyFrameAnya[0].movAnya_z = 20.0f;
	KeyFrameAnya[0].rotacionAnya = 40;

	KeyFrameAnya[1].movAnya_x = 3.0f;
	KeyFrameAnya[1].movAnya_y = 0.0f;
	KeyFrameAnya[1].movAnya_z = 40.0f;
	KeyFrameAnya[1].rotacionAnya = -40;

	KeyFrameAnya[2].movAnya_x = 5.0f;
	KeyFrameAnya[2].movAnya_y = 0.0f;
	KeyFrameAnya[2].movAnya_z = 48.0f;
	KeyFrameAnya[2].rotacionAnya = 40;

	KeyFrameAnya[3].movAnya_x = 6.0f;
	KeyFrameAnya[3].movAnya_y = 0.0f;
	KeyFrameAnya[3].movAnya_z = 60.0f;
	KeyFrameAnya[3].rotacionAnya = -40;

	KeyFrameAnya[4].movAnya_x = 0.0f;
	KeyFrameAnya[4].movAnya_y = 0.0f;
	KeyFrameAnya[4].movAnya_z = 20.0f;
	KeyFrameAnya[4].rotacionAnya = 40;
